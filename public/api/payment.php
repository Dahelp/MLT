...
$order = ['intent' => 'CAPTURE', 'purchase_units' => [['reference_id' => $reference, 'description' => 'MLT ' . ucfirst($collection) . ' Collection · ' . $days . ' days', 'amount' => ['currency_code' => 'EUR', 'value' => number_format((float)$amount, 2, '.', '')]]], 'application_context' => ['return_url' => $origin . '/api/paypal-capture.php?reference=' . rawurlencode($reference), 'cancel_url' => $origin . '/plan/?payment=cancelled&reference=' . rawurlencode($reference), 'user_action' => 'PAY_NOW']];
